...
contract("Employees", async () => {
    ...
    it("shouldn't create a third new employee", async () => {
        let instance = await Employees.deployed();
        await truffleAssert.fails(instance.createEmployee("Samuel", "Norway", "21.12.2020", "Samuel@email.com", department, department, 20));
